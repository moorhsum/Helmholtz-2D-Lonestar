...
//	Generates Single Layer Helmholtz Kernels for Neumann problem, using off-interface evaluation
//	This was for comparison in circle case only since it's not a Combination approach
